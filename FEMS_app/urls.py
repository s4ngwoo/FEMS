...
urlpatterns = [
    ...
    path('industrial/sales-production/', views.sales_production_industrial, name='sales_production_industrial'),  # 업종별 매출/생산액
    path('industrial/profit/', views.profit_industrial, name='profit_industrial'),  # 업종별 매출 영업이익률/당기순이익
    path('industrial/investment/', views.investment_industrial, name='investment_industrial'),  # 업종별 설비투자액/설비투자효율
    path('industrial/management-investment/', views.management_investment_industrial, name='management_investment_industrial'),  # 업종별 경영투자현황
